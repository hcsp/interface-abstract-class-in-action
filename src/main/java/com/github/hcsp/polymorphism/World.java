...
public class World {
    ...
    static class 动物类 implements 动物 {
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }

    static class 鸟 extends 动物类 implements 会飞的东西, 会叫的东西 {
        public void 飞() {
    ...
    static class 蝴蝶 extends 动物类 implements 会飞的东西 {
        public void 飞() {
    ...
    static class 猫 extends 动物类 implements 会叫的东西 {
        public void 叫() {
            System.out.println("喵喵喵");
        }
    }

    static class 狗 extends 动物类 implements 会叫的东西 {
