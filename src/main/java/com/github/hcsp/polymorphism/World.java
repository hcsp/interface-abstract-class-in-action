...
public class World {
    ...
    public static void 动物都能新陈代谢() {
        for (Object obj : objects) {
            if (obj instanceof 生命体) {
                ((生命体) obj).新陈代谢();
            }
        }
    }
    static  class 生命体 implements 动物{
        public void 新陈代谢(){
            System.out.println("新陈代谢");
        }
    }
    static class 鸟 extends 生命体 implements 会飞的东西,会叫的东西{
        @Override
        public void 飞() {
    ...
    static  class 蝴蝶 extends 生命体 implements 会飞的东西 {
    ...
    static  class 猫 extends 生命体 implements 会叫的东西  {
    ...
    static  class 狗 extends 生命体 implements 会叫的东西 {
