...
public class World {
    ...
    public static class 有机体 implements 动物{
        @Override
        public void 新陈代谢() {
    ...
    public static class 鸟 extends 有机体 implements 会飞的东西,会叫的东西{
        @Override
        public void 叫() {
    ...
    static class 蝴蝶 extends 有机体 implements 会飞的东西{
        public void 飞() {
    ...
    static class 猫 extends 有机体 implements 会叫的东西{
        public void 叫() {
            System.out.println("喵喵喵");
        }
    }

    static class 狗 extends 有机体 implements 会叫的东西{
        public void 叫() {
