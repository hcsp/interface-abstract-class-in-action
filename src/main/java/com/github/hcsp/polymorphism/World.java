...
public class World {
    ...
    static class 蝴蝶 extends 是动物 implements 会飞的东西{
    ...
    static class 猫 extends 是动物 implements 会叫的东西{
        public void 叫() {
            System.out.println("喵喵喵");
        }
    }

    static class 狗 extends 是动物 implements 会叫的东西{
        public void 叫() {
    ...
    static class 是动物 implements 动物{
        @Override
        public void 新陈代谢() {
    ...
    static class 鸟类 extends 是动物 implements 会飞的东西,会叫的东西{
        @Override
        public void 飞() {
