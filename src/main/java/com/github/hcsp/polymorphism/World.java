...
public class World {
    ...
    static class 麻雀 extends AbstractAnimal implements 会飞的东西,会叫的东西{
        @Override
        public void 叫() {
    ...
    static class 喜鹊 extends AbstractAnimal implements 会飞的东西,会叫的东西{
        @Override
        public void 叫() {
            System.out.println("叽叽喳喳");
        }
    ...
    static abstract class AbstractAnimal implements  动物,会飞的东西
    {
        @Override
        public void 新陈代谢() {
