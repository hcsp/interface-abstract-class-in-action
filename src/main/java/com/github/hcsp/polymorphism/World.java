...
public class World {
    ...
    public static abstract class VirtulAnimal implements 动物 {
        @Override
        public void 新陈代谢() {
    ...
    static class 猫 extends VirtulAnimal implements 会叫的东西 {
    ...
    static class 狗 extends VirtulAnimal implements 会叫的东西 {
