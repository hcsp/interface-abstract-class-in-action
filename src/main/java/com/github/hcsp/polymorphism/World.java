...
public class World {
    ...
    static class 麻雀 extends Bird implements 动物, 会叫的东西, 会飞的东西{
        public void 叫() {
            System.out.println("叽叽喳喳");
        }
    }

    static class 喜鹊 extends Bird implements 动物, 会叫的东西, 会飞的东西{
        public void 叫() {
            System.out.println("叽叽喳喳");
        }
    }

    static class 蝴蝶 extends Animal implements 动物, 会飞的东西{
        public void 飞() {
    ...
    static class 猫 extends Animal implements 动物, 会叫的东西{
        public void 叫() {
            System.out.println("喵喵喵");
        }
    }

    static class 狗 extends Animal implements 动物, 会叫的东西{
        public void 叫() {
