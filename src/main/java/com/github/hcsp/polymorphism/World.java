...
public class World {
    ...
    static class 鸟 extends 小动物 implements 会飞的东西, 会叫的东西{
        public void 叫() {
    ...
    static class 蝴蝶 extends 小动物 implements 会飞的东西 {
    ...
    static class 猫 extends 小动物 implements 会叫的东西 {
    ...
    static class 狗 extends 小动物 implements 会叫的东西 {
