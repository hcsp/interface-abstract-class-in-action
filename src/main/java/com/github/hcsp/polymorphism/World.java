...
public class World {
    ...
    public static void 动物都能新陈代谢() {
        for (Object obj : objects) {
            if (obj instanceof 普通动物) {
                ((普通动物) obj).新陈代谢();
            }
        }
    }

    static class 普通动物 implements 动物{
        @Override
        public void 新陈代谢() {
    ...
    static class 鸟儿 extends 普通动物 implements 会飞的东西,会叫的东西{
        @Override
        public void 飞() {
    ...
    static class 麻雀 extends 鸟儿 {
    }

    static class 喜鹊 extends 鸟儿 {
    }


    static class 蝴蝶 extends 普通动物 implements 会飞的东西{
        @Override
        public void 飞() {
    ...
    static class 猫 extends 普通动物 implements 会叫的东西{
        @Override
        public void 叫() {
    ...
    static class 狗 extends 普通动物 implements 会叫的东西{
        @Override
        public void 叫() {
