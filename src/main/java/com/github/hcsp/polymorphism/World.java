...
public class World {
    ...
    static class 活的生物 implements 动物{           //活物类
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }
    static class 飞鸟 extends 活的生物 implements 会飞的东西,会叫的东西{       //飞鸟类
        public void 飞() {
    ...
    static class 麻雀 extends 飞鸟 { }

    static class 喜鹊 extends 飞鸟 { }

    static class 蝴蝶 extends 活的生物 implements 会飞的东西 {
    ...
    static class 猫 extends 活的生物 implements 会叫的东西 {
    ...
    static class 狗 extends 活的生物 implements 会叫的东西 {
