...
public class World {
    ...
    public static void 会飞的东西飞() {
        for (Object obj : objects) {
            if (obj instanceof 会飞的东西) {  //不止可以判断是否属于某个类，还可以判断是否属于某个接口
                ((会飞的东西)obj).飞();
            }
        }
    }
    ...
    static class 各种动物 implements 动物{   //？implements 动物
        public void 新陈代谢() {
            System.out.println("新陈代谢");
        }
    }

    static class 鸟 extends 各种动物 implements 会叫的东西, 会飞的东西{
    ...
    static class 蝴蝶 extends 各种动物 implements 会飞的东西{
    ...
    static class 猫  extends 各种动物 implements 会叫的东西{
    ...
    static class 狗 extends 各种动物 implements 会叫的东西{
